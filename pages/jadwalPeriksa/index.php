                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            require 'config/koneksi.php';
                                            $cekJadwalPeriksa = "SELECT * FROM daftar_poli INNER JOIN jadwal_periksa ON daftar_poli.id_jadwal = jadwal_periksa.id WHERE jadwal_periksa.id_dokter = '$id_dokter'";
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="hari" name="hari">
                                                                <?php
                                                                   ...
                                                                   foreach($hariArray as $hari){
                                                                ?>
                                                                <option value="<?php echo $hari ?>" <?php echo $data['hari'] == $hari ? 'selected' : '' ?>>
                                                                    <?php echo $hari ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="pages/jadwalPeriksa/hapusJadwal.php" method="post">
                                                        ...
                                                        <button type="submit" name="hapusJadwal" class="btn btn-danger">Hapus</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
