<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (mysqli_num_rows($queryCekData) > 0) {
            ...
            $daftarPoli = "INSERT INTO daftar_poli (id_pasien, id_jadwal, keluhan, no_antrian) VALUES ('$idPasien', '$idJadwal', '$keluhan', '$antrianBaru')";
            ...
            $daftarPoli = "INSERT INTO daftar_poli (id_pasien, id_jadwal, keluhan, no_antrian) VALUES ('$idPasien', '$idJadwal', '$keluhan', '$noAntrian')";
            $queryDaftarPoli = mysqli_query($mysqli, $daftarPoli);
            if ($queryDaftarPoli) {
                echo '<script>alert("Berhasil mendaftar poli");window.location.href="../../daftarPoliklinik.php";</script>';
            } else {
