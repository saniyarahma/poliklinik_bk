                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $query = "SELECT pasien.nama, daftar_poli.keluhan, daftar_poli.id, daftar_poli.no_antrian, (SELECT COUNT(*) FROM periksa WHERE periksa.id_daftar_poli = daftar_poli.id) AS sudah_diperiksa FROM daftar_poli INNER JOIN pasien ON daftar_poli.id_pasien = pasien.id INNER JOIN jadwal_periksa ON daftar_poli.id_jadwal = jadwal_periksa.id INNER JOIN dokter ON jadwal_periksa.id_dokter = dokter.id WHERE dokter.id = '$id_dokter' ORDER BY daftar_poli.no_antrian ASC";
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Form edit data periksa disini -->
                                                        <?php
                                                            $idDaftarPoli = $data['id'];
                                                            $ambilDataPeriksa = mysqli_query($mysqli,"SELECT * FROM periksa WHERE periksa.id_daftar_poli = '$idDaftarPoli'");
                                                            $ambilData = mysqli_fetch_assoc($ambilDataPeriksa);
                                                        ?>
                                                        <form action="pages/memeriksaPasien/updateMemeriksa.php" method="post">
